    ...
    <footer className="site-footer">
      <div className="container footer-inner">
        <div className="footer-brand">
          <span className="footer-brand-name">{t.header.brandName}</span>
          <p className="footer-tagline">{f.tagline}</p>
        </div>

        <div className="footer-nav">
          <span className="footer-col-title">{f.navTitle}</span>
          <Link to="/">{f.navHome}</Link>
          <Link to="/expertise">{f.navExpertise}</Link>
          <Link to="/solution">{f.navSolution}</Link>
          <Link to="/contact">{f.navContact}</Link>
        </div>
